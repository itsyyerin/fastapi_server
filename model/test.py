...
# 두 화자를 비교하는 함수 (동일인이 아닐 경우 점수 변환 없이 유지)
def compare_speakers(audio1, audio2):
    try:
        ...
        if similarity.item() >= 0.5:
            ...
            return "different", similarity.item()  # 동일인이 아니면 원래 점수 반환
...
compare_speaker_file = "C:\\Users\\sjiye\\Downloads\\시온2.mp4"  # 비교할 화자의 동영상 파일 경로
